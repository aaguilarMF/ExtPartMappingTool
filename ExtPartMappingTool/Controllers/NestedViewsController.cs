...
namespace ExtPartMappingTool.Controllers
{
    ...
    public class NestedViewsController : Controller
    {
        // GET: NestedViews
        ...
        public ActionResult DevelopmentView() //deprecated.
        {
            return View();
        }
        public ActionResult ProductionView() //Ain't gonna happen. no need indeed. Wocka wocka.
        {
            return View();
        }
